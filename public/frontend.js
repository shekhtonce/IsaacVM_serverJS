...
async function loadCategories(container, location) {
  ...
  async function loadProducts(container, catId) {
    try {
      ...
      const addCartButtons = container.querySelectorAll('.add-to-cart-btn');
...
function addItemToCart(newItem) {
  // Get current cart from scripts.js function
  let cart = loadCart();
  ...
  // Save and update display using functions from scripts.js
  saveCart(cart);
